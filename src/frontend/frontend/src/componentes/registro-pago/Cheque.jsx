...
export const Cheque = () => {
    ...
    let validate = () => {
        ...
        if(!pagoForm.medioPago.numeroCheque){
            errors.push("El campo 'Numero cheque' no puede ser vacío")
        }
        if(!pagoForm.medioPago.fechaCobro){
            errors.push("El campo 'Fecha cobro' no puede ser vacío")
        }
        if(!pagoForm.medioPago.banco){
            errors.push("El campo 'Banco' no puede ser vacío")
        }
        if(!pagoForm.medioPago.observacion){
            errors.push("El campo 'Observacion' no puede ser vacío")
        }
        if(pagoForm.medioPago.numeroCheque && isNaN(pagoForm.medioPago.numeroCheque)){
            errors.push("El campo 'Numero cheque' debe ser un número")
        }
